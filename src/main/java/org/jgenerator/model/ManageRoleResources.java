...
public class ManageRoleResources extends Entity{
	/**
	 * @type long
	...
	private Integer andLikeManageRoleId;
	private Integer startLikeManageRoleId; 
	private Integer resourceId;
	private Integer andLikeResourceId;
	private Integer startLikeResourceId; 
	...
	public void setAndLikeManageRoleId(Integer andLikeManageRoleId) {
		this.andLikeManageRoleId = andLikeManageRoleId;
	}
	
	public Integer getAndLikeManageRoleId() {
		return this.andLikeManageRoleId;
	}
	
	public void setStartLikeManageRoleId(Integer startLikeManageRoleId) {
		this.startLikeManageRoleId = startLikeManageRoleId;
	}
	
	public Integer getStartLikeManageRoleId() {
		return this.startLikeManageRoleId;
	}
	...
	public void setAndLikeResourceId(Integer andLikeResourceId) {
		this.andLikeResourceId = andLikeResourceId;
	}
	
	public Integer getAndLikeResourceId() {
		return this.andLikeResourceId;
	}
	
	public void setStartLikeResourceId(Integer startLikeResourceId) {
		this.startLikeResourceId = startLikeResourceId;
	}
	
	public Integer getStartLikeResourceId() {
		return this.startLikeResourceId;
	}
