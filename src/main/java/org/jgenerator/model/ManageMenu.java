...
public class ManageMenu extends Entity{
	/**
	 * @type long
	...
	private Integer andLikeType;
	private Integer startLikeType; 
	private String url;
	...
	public void setAndLikeType(Integer andLikeType) {
		this.andLikeType = andLikeType;
	}
	
	public Integer getAndLikeType() {
		return this.andLikeType;
	}
	
	public void setStartLikeType(Integer startLikeType) {
		this.startLikeType = startLikeType;
	}
	
	public Integer getStartLikeType() {
		return this.startLikeType;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ManageMenu other = (ManageMenu) obj;
		if (id == null) {
			if (other.id != null)
				return false;
