...
public class ManageRole extends Entity{
	/**
	 * @type long
	...
	private String andLikeDescription;
	private String startLikeDescription; 
	...
	public void setAndLikeDescription(String andLikeDescription) {
		this.andLikeDescription = andLikeDescription;
	}
	
	public String getAndLikeDescription() {
		return this.andLikeDescription;
	}
	
	public void setStartLikeDescription(String startLikeDescription) {
		this.startLikeDescription = startLikeDescription;
	}
	
	public String getStartLikeDescription() {
		return this.startLikeDescription;
	}
