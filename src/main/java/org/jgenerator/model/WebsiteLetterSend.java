...
public class WebsiteLetterSend extends Entity{
	/**
	 * @type long
	...
	private Integer andLikeManageUserId;
	private Integer startLikeManageUserId; 
	private String receiveUser;
	private String andLikeReceiveUser;
	private String startLikeReceiveUser; 
	private String sendTime;
	private String andLikeSendTime;
	private String startLikeSendTime; 
	...
	public void setAndLikeManageUserId(Integer andLikeManageUserId) {
		this.andLikeManageUserId = andLikeManageUserId;
	}
	
	public Integer getAndLikeManageUserId() {
		return this.andLikeManageUserId;
	}
	
	public void setStartLikeManageUserId(Integer startLikeManageUserId) {
		this.startLikeManageUserId = startLikeManageUserId;
	}
	
	public Integer getStartLikeManageUserId() {
		return this.startLikeManageUserId;
	}
	...
	public void setAndLikeReceiveUser(String andLikeReceiveUser) {
		this.andLikeReceiveUser = andLikeReceiveUser;
	}
	
	public String getAndLikeReceiveUser() {
		return this.andLikeReceiveUser;
	}
	
	public void setStartLikeReceiveUser(String startLikeReceiveUser) {
		this.startLikeReceiveUser = startLikeReceiveUser;
	}
	
	public String getStartLikeReceiveUser() {
		return this.startLikeReceiveUser;
	}
	...
	public void setAndLikeSendTime(String andLikeSendTime) {
		this.andLikeSendTime = andLikeSendTime;
	}
	
	public String getAndLikeSendTime() {
		return this.andLikeSendTime;
	}
	
	public void setStartLikeSendTime(String startLikeSendTime) {
		this.startLikeSendTime = startLikeSendTime;
	}
	
	public String getStartLikeSendTime() {
		return this.startLikeSendTime;
	}
