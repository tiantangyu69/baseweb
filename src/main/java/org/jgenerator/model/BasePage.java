...
public class BasePage extends Entity{
	/**
	 * @type long
	...
	private String andLikeContend;
	private String startLikeContend; 
	...
	public void setAndLikeContend(String andLikeContend) {
		this.andLikeContend = andLikeContend;
	}
	
	public String getAndLikeContend() {
		return this.andLikeContend;
	}
	
	public void setStartLikeContend(String startLikeContend) {
		this.startLikeContend = startLikeContend;
	}
	
	public String getStartLikeContend() {
		return this.startLikeContend;
	}
