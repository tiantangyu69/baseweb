...
public class WebsiteLogo extends Entity{
	/**
	 * @type long
	...
	private Integer andLikePicSize;
	private Integer startLikePicSize; 
	private String picType;
	private String andLikePicType;
	private String startLikePicType; 
	private String picUrl;
	private String andLikePicUrl;
	private String startLikePicUrl; 
	...
	public void setAndLikePicSize(Integer andLikePicSize) {
		this.andLikePicSize = andLikePicSize;
	}
	
	public Integer getAndLikePicSize() {
		return this.andLikePicSize;
	}
	
	public void setStartLikePicSize(Integer startLikePicSize) {
		this.startLikePicSize = startLikePicSize;
	}
	
	public Integer getStartLikePicSize() {
		return this.startLikePicSize;
	}
	...
	public void setAndLikePicType(String andLikePicType) {
		this.andLikePicType = andLikePicType;
	}
	
	public String getAndLikePicType() {
		return this.andLikePicType;
	}
	
	public void setStartLikePicType(String startLikePicType) {
		this.startLikePicType = startLikePicType;
	}
	
	public String getStartLikePicType() {
		return this.startLikePicType;
	}
	...
	public void setAndLikePicUrl(String andLikePicUrl) {
		this.andLikePicUrl = andLikePicUrl;
	}
	
	public String getAndLikePicUrl() {
		return this.andLikePicUrl;
	}
	
	public void setStartLikePicUrl(String startLikePicUrl) {
		this.startLikePicUrl = startLikePicUrl;
	}
	
	public String getStartLikePicUrl() {
		return this.startLikePicUrl;
	}
